...
function OptionItem({ id, heading='No Heading', subheading='', bettingline, odds, onBetClose }: { id: string, heading: string, subheading: string, bettingline: number, odds: number, onBetClose: (optionid: string, side: 'o' | 'u' | 'h' | 'm') => Promise<any> }) {
